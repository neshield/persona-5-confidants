...
import '../../index.css'
import AvailableOn from './AvailableOn.jsx'
import Requirements from './Requirements.jsx';
import RankLevel from './RankLevel.jsx'
import RankText from './RankText.jsx';
import RomanceAvailable from './RomanceAvailable.jsx';
  ...
  render () {
    ...
    return (
      <div className='RankItem'>
        ...
        <AvailableOn available={available}/>
        <Requirements requires={requires}/>
        <RankText text={text}/>
        <RomanceAvailable romance={romance}/>
        {this.renderChoices(choices)}
        {this.renderMementosRequest(mementosRequest)}
        {this.renderAfterMementos(afterMementos)}
        {this.renderUnlocks(unlocks)}
